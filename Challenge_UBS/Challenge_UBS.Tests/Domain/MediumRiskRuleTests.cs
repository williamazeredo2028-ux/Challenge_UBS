...
{
    private readonly MediumRiskRule _rule = new();

    [Fact]
    public void IsMatch_ShouldReturnTrue_WhenValueIsGreaterOrEqualToOneMillion_AndClientIsPublic()
    {
        // Arrange
        var trade = new Trade(
            value: 1_500_000m,
    ...
    [Fact]
    public void IsMatch_ShouldReturnFalse_WhenClientSectorIsPrivate()
    {
        // Arrange
        var trade = new Trade(
            value: 2_000_000m,
